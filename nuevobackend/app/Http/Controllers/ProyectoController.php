...
class ProyectoController extends Controller
{
    ...
    public function proyectoid(Proyecto $proyecto){
        $proyecto =Proyecto::with(['sociedads.empresas','personas','empresas','programa', 'tipo', 'departamento','codigos', 'funcionarios','lotes','lotes.personas','lotes.empresas','lotes.sociedads','lotes.sociedads.empresas', 'contratos','contratos.personas','contratos.empresas','contratos.sociedads','adjudicados'])
