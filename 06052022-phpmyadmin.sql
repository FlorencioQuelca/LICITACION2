...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-05-2022 a las 21:38:11
...
CREATE TABLE `archivos` (
  ...
  `tamanio` int(11) NOT NULL DEFAULT 1,
...
--
-- Estructura de tabla para la tabla `contrato_persona`
--

CREATE TABLE `contrato_persona` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
(321, 'CONSTRUCTORA \'Z3\'', '4035689017', 'SILVIA GLADYS ZARATE BERNAL', 'BULLAIN N° 61 AV. ESPAÑA Y TOMAS FRIAS', '73817416', NULL, 'SILZARATE@HOTMAIL.COM', NULL, 'NINGUNA', '2022-02-02 10:55:13', '2022-02-02 10:55:13'),
...
(145, '2022_01_26_180259_create_contratos_table', 2),
...
(150, '2022_05_05_192632_create_archivos_table', 2),
(151, '2022_05_06_144315_create_detalle1s_table', 2),
(152, '2022_05_06_150507_create_contrato_persona_table', 2);
...
(44, 'App\\Models\\User', 1, 'auth_token', 'eea71ddadcf1e68348c26461f5bf2ccc482a792f289703a1c90cc14edfa6a393', '[\"*\"]', '2022-05-04 11:52:54', '2022-02-23 14:24:57', '2022-05-04 11:52:54'),
...
(48, 'App\\Models\\User', 1, 'auth_token', '794959c8d6cf6394aa5c704f2a24c7a7d242532856bd1fd2d2d989ce6a8891e6', '[\"*\"]', '2022-05-05 16:41:24', '2022-03-15 08:37:16', '2022-05-05 16:41:24'),
(49, 'App\\Models\\User', 1, 'auth_token', '3af4743e1665de8698cf1a73d6857d579cc02afb8e14ebf09129cee000c933ba', '[\"*\"]', '2022-04-25 20:20:19', '2022-03-15 16:17:42', '2022-04-25 20:20:19'),
(50, 'App\\Models\\User', 3, 'auth_token', '4d458a9583241d014a24d696b1727d79570f4e4d28f67fba82ce99dbcd0a0d60', '[\"*\"]', '2022-05-04 17:18:44', '2022-03-24 14:29:00', '2022-05-04 17:18:44'),
...
(53, 'App\\Models\\User', 1, 'auth_token', 'ade1ac910ae2b3f8262f5d3166e47ec80ca0a8bc9629da76d2f0a45ee7030168', '[\"*\"]', '2022-05-04 23:00:46', '2022-05-04 22:50:42', '2022-05-04 23:00:46'),
(55, 'App\\Models\\User', 1, 'auth_token', '2f4b8aa32b307ae4798e1d3903cfb49ea285d8e29f8cc4253a6fc14dd121e4e6', '[\"*\"]', '2022-05-06 19:32:20', '2022-05-06 19:16:50', '2022-05-06 19:32:20');
...
(522, '2527993', 'CONDORI', 'CAUNA', 'REYNALDO', 'REYNALDO CONDORI CAUNA', '2527993', 'LIC.', 'CALLE CHIUTA Nº 174 HUAYNA POTOSI 2DA SECCION EL ALTO NORTE', NULL, '68078154', NULL, 'RCCONDORI@FPS.GOB.BO', 'HOMBRE', 'SERVIDOR PUBLICO', NULL, 'ACTIVO', '2022-02-22 15:57:36', '2022-02-22 15:57:36'),
...
--
-- Indices de la tabla `contrato_persona`
--
ALTER TABLE `contrato_persona`
  ADD PRIMARY KEY (`id`),
  ADD KEY `contrato_persona_contrato_id_foreign` (`contrato_id`),
  ADD KEY `contrato_persona_persona_id_foreign` (`persona_id`);
...
--
-- AUTO_INCREMENT de la tabla `contrato_persona`
--
ALTER TABLE `contrato_persona`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `contrato_persona`
--
ALTER TABLE `contrato_persona`
  ADD CONSTRAINT `contrato_persona_contrato_id_foreign` FOREIGN KEY (`contrato_id`) REFERENCES `contratos` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `contrato_persona_persona_id_foreign` FOREIGN KEY (`persona_id`) REFERENCES `personas` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
