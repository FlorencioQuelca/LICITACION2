<template>
  <div class="q-pa-md">
    ...
    <q-table
      :filter="filter"
      title="INFORMES MENSUALES DE VEHICULOS FPS LA PAZ"
      :rows="data"
      :columns="columns"
      row-key="seguimiento"
...
const  columns= [
  { name: 'seguimiento', required: true,align:"left", label:'Nro. Seguimiento',field: "seguimiento", sortable: true},
  { name: 'fechaini', align:"left",label: 'Fecha Inicio', field: 'fechaini', sortable: true },
  { name: 'fechafin', align:"left",label: 'Fecha fin', field: 'fechafin', sortable: true },
  { name: 'car', align:"center",label: 'AUTO descripcion', field: 'car', sortable: true },
  { name: 'taller', align:"center",label: 'Taller enviado', field: 'taller', sortable: true },
